...
HD_PWD='/home/lyc/Vivado/lab6/BubbleSort_VGA/BubbleSort_VGA.runs/ClockingWizard_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ClockingWizard_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ClockingWizard_1.tcl
