...
#
# Generated by export_simulation on Thu May 30 19:57:49 CST 2019
#
################################################################################
...
'-reset_run' switch to the './ClockingWizrad_0.sh' script.

./ClockingWizrad_0.sh -reset_run
...
./ClockingWizrad_0.sh -noclean_files

For more information on the script, please type './ClockingWizrad_0.sh -help'.
