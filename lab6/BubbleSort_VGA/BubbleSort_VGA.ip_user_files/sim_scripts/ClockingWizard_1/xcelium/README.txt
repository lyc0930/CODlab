...
#
# Generated by export_simulation on Thu May 30 20:01:17 CST 2019
#
################################################################################
...
'-reset_run' switch to the './ClockingWizard_1.sh' script.

./ClockingWizard_1.sh -reset_run
...
./ClockingWizard_1.sh -noclean_files

For more information on the script, please type './ClockingWizard_1.sh -help'.
