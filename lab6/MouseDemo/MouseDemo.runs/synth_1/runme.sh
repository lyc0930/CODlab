...
HD_PWD='/home/lyc/Vivado/lab6/MouseDemo/MouseDemo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MouseDemo_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MouseDemo_top.tcl
