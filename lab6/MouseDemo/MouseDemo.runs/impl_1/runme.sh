...
HD_PWD='/home/lyc/Vivado/lab6/MouseDemo/MouseDemo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MouseDemo_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MouseDemo_top.tcl -notrace
