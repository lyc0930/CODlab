...
HD_PWD='/home/lyc/Vivado/lab6/Fibonacci_VGA/Fibonacci_VGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fibonacci_VGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Fibonacci_VGA.tcl
