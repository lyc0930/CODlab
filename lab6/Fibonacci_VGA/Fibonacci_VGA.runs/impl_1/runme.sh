...
HD_PWD='/home/lyc/Vivado/lab6/Fibonacci_VGA/Fibonacci_VGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Fibonacci_VGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Fibonacci_VGA.tcl -notrace
