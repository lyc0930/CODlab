...
HD_PWD='/home/lyc/Vivado/lab6/Fibonacci_VGA/Fibonacci_VGA.runs/Clocking_Wizard_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Clocking_Wizard_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Clocking_Wizard_1.tcl
