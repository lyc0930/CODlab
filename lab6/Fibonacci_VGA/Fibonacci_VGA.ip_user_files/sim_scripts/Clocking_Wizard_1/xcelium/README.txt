...
#
# Generated by export_simulation on Thu May 30 16:45:39 CST 2019
#
################################################################################
...
'-reset_run' switch to the './Clocking_Wizard_1.sh' script.

./Clocking_Wizard_1.sh -reset_run
...
./Clocking_Wizard_1.sh -noclean_files

For more information on the script, please type './Clocking_Wizard_1.sh -help'.
