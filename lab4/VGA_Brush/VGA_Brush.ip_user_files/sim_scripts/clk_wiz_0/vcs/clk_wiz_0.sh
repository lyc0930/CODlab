...
#
# Generated by Vivado on Thu Apr 18 09:30:17 CST 2019
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../VGA_Brush.srcs/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../VGA_Brush.srcs/sources_1/ip/clk_wiz_0" \
    "$ref_dir/../../../../VGA_Brush.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/lyc/Vivado/lab4/VGA_Brush/VGA_Brush.cache/compile_simlib/vcs"
  fi
