...
HD_PWD='/home/lyc/Vivado/lab4/VGA_Brush/VGA_Brush.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Brush.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Brush.tcl
