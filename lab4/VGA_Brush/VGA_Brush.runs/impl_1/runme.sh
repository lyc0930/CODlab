...
HD_PWD='/home/lyc/Vivado/lab4/VGA_Brush/VGA_Brush.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Brush.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Brush.tcl -notrace
