...
HD_PWD='/home/lyc/Vivado/lab5/MulticycleCPU/MulticycleCPU.runs/ClockWizard_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ClockWizard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ClockWizard.tcl
