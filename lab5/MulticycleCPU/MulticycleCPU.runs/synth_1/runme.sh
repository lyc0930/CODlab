...
HD_PWD='/home/lyc/Vivado/lab5/MulticycleCPU/MulticycleCPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPUDebugDisplay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPUDebugDisplay.tcl
