...
HD_PWD='/home/lyc/Vivado/lab5/MulticycleCPU/MulticycleCPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CPUDebugDisplay.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CPUDebugDisplay.tcl -notrace
