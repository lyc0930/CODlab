...
HD_PWD='/home/lyc/Vivado/lab1/Register/Register.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Register.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Register.tcl -notrace
